		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="12">
						<el-form-item label="调整目标" prop="diaozhengmubiao">
							<el-input class="list_inp" v-model="form.diaozhengmubiao" placeholder="调整目标"
                                type="text"
								:readonly="!isAdd||disabledForm.diaozhengmubiao?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="调整建议" prop="diaozhengjianyi">
							<el-input v-model="form.diaozhengjianyi" placeholder="调整建议" type="textarea"
							:readonly="!isAdd||disabledForm.diaozhengjianyi?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const disabledForm = ref({
        ...
        xingming : false,
        yundongmubiao : false,
        diaozhengmubiao : false,
        diaozhengjianyi : false,
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='diaozhengmubiao'){
					form.value.diaozhengmubiao = row[x];
					disabledForm.value.diaozhengmubiao = true;
					continue;
				}
				if(x=='diaozhengjianyi'){
					form.value.diaozhengjianyi = row[x];
					disabledForm.value.diaozhengjianyi = true;
					continue;
				}
				if(x=='gengxinshijian'){
