...
class MainActivity : BaseBindingActivity<ActivityMainLayoutBinding>() {
    ...
    private val fragments = mutableListOf(
        ...
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_EXAMPAPER).withBoolean("mHasBack",false).withBoolean("mIsHome",true).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_FORUM).withBoolean("mHasBack",false).withBoolean("mIsHome",true).navigation() as Fragment,
